  ...
  return (
    <>
      ...
      <nav className={`cc-nav ${scrolled ? "cc-nav--scrolled" : ""}`}>
        ...
        {/* Desktop right side — nav links + auth inline */}
      ...
      {/* ── MOBILE SEARCH BAR — permanently below navbar on mobile ── */}
...
const navCss = `
  ...
  .cc-logo__icon {
    ...
    color: #fff; box-shadow: 2px 2px 0 #111; transition: transform 0.18s;
  }
  ...
  .cc-search__input {
    ...
    font-family: 'Jost', sans-serif; font-size: 0.83rem; font-weight: 500; color: #111;
    min-width: 0;
  }
  ...
  .cc-search__clear {
    ...
    color: #666; cursor: pointer; transition: background 0.15s, color 0.15s; padding: 0;
  }
  ...
  .cc-suggestions {
    ...
    overflow: hidden; box-shadow: 4px 4px 0 #111;
    animation: ccDropIn 0.16s cubic-bezier(.22,1,.36,1) both;
    z-index: 300;
  }
  .cc-suggestions--mobile {
    position: static;
    margin-top: 8px;
    animation: none;
  }
  ...
  .cc-suggestion-item {
    ...
    border-bottom: 1px solid #f5f5f5; cursor: pointer; text-align: left;
  ...
  .cc-suggestion-item__img-wrap {
    ...
    border-radius: 5px; overflow: hidden; border: 1.5px solid #111;
  }
  ...
  .cc-suggestion-item__price {
    font-size: 0.84rem; font-weight: 700; color: #FF3E5E; flex-shrink: 0;
    font-family: 'Jost', sans-serif;
  }
  ...
  .cc-suggestions__footer {
    ...
    padding: 10px 12px; background: #f9f9f9; border: none; border-top: 1.5px solid #eee;
    font-family: 'Jost', sans-serif; font-size: 0.8rem; font-weight: 700; color: #111;
    cursor: pointer; transition: background 0.15s;
  }
  .cc-suggestions__footer:hover { background: #FFE14D; }

  /* ── Right side (desktop) — links + divider + auth all inline ── */
  .cc-right {
    display: flex; align-items: center; gap: 4px; flex-shrink: 0;
  }
  .cc-divider {
    width: 1.5px; height: 22px; background: #ddd; margin: 0 4px; flex-shrink: 0;
  }
  .cc-link {
    display: flex; align-items: center; gap: 5px;
    padding: 6px 11px; background: none; border: 2px solid transparent; cursor: pointer;
    font-family: 'Jost', sans-serif; font-size: 0.78rem; font-weight: 600;
    color: #444; letter-spacing: 0.02em; border-radius: 6px; transition: all 0.15s;
    white-space: nowrap;
  }
  .cc-link:hover {
  ...
  .cc-btn {
    ...
    padding: 6px 14px; font-family: 'Jost', sans-serif; font-size: 0.77rem;
    font-weight: 700; letter-spacing: 0.04em; border-radius: 6px;
  ...
  /* ── Avatar (just sign out dropdown now) ── */
  ...
  .cc-dropdown {
    ...
    border: 2px solid #111; border-radius: 8px; padding: 6px;
    box-shadow: 4px 4px 0 #111;
    animation: ccPopIn 0.16s cubic-bezier(.22,1,.36,1) both; z-index: 200;
  }
  @keyframes ccPopIn {
  ...
  .cc-dropdown__item {
    ...
    border-radius: 5px; cursor: pointer; font-family: 'Jost', sans-serif;
    font-size: 0.8rem; font-weight: 500; color: #444; text-align: left; transition: all 0.12s;
  }
  ...
  .cc-mobile-search-bar .cc-suggestions--mobile {
    border-radius: 6px;
    border: 2px solid #111;
    box-shadow: 3px 3px 0 #111;
    overflow: hidden;
  ...
  @media (max-width: 1024px) {
    ...
    .cc-mobile-search-bar { display: block; }
    .cc-nav { padding: 0 14px; gap: 8px; }
  }

  @media (min-width: 1025px) {
    .cc-mobile-search-bar { display: none; }
  }
`;