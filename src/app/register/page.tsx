      ...
      <div className="page">
        ...
        <div className="card">
          ...
          <div className="logo">
            ...
            <span className="logo-text">AzeemCosmatics</span>
          </div>
          ...
          {success ? (
            ...
            <>
              ...
              <p className="subtitle">Join AzeemCosmatics today — it&apos;s free</p>
              ...
              <div className="form">
                ...
                <button className="submit-btn" onClick={register} disabled={loading}>
...
const css = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .success-title{font-size:1.6rem;font-weight:900;color:#111;letter-spacing:-.03em;margin-bottom:8px}
  .success-msg{font-size:.88rem;color:#666;line-height:1.6}
